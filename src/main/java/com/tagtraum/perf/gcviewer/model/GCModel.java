...
public class GCModel implements Serializable {
	...
	private boolean includeTenuringInfo = false;
	private IntData desiredSurvivorThreshold;//LMA
	private IntData desiredSurvivorSize;//LMA
	private IntData desiredSurvivorAge;//LMA
	...
	public GCModel(boolean countTenuredAsFull) {
		...
		this.desiredSurvivorSize = new IntData();
		this.desiredSurvivorThreshold = new IntData();
		this.desiredSurvivorAge = new IntData();
	}
	...
	//LMA
	public boolean isIncludeTenuringInfo() {
		return includeTenuringInfo;
	}
	...
	public void add(final AbstractGCEvent<?> abstractEvent) {
		...
		//LMA : add tenuring information
		if(abstractEvent.getTenuringInformation() != null){
			includeTenuringInfo = true;
			desiredSurvivorThreshold.add(abstractEvent.getTenuringInformation().getNewThreshold());
			desiredSurvivorSize.add(abstractEvent.getTenuringInformation().getSurvivorSize());
			desiredSurvivorAge.add(abstractEvent.getTenuringInformation().getMaxAge());
		}
	...
	//LMA
	public IntData getDesiredSurvivorThreshold() {
		return desiredSurvivorThreshold;
	}

	//LMA
	public IntData getDesiredSurvivorSize() {
		return desiredSurvivorSize;
	}

	//LMA
	public IntData getDesiredSurvivorAge() {
		return desiredSurvivorAge;
	}
