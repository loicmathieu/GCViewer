...
public abstract class AbstractGCEvent<T extends AbstractGCEvent<T>> implements Serializable {
	...
	private TenuringInformation tenuringInfo;
	...
	public void setTenuringInformation(TenuringInformation tenuringInfo) {
		this.tenuringInfo = tenuringInfo;
	}

	public TenuringInformation getTenuringInformation() {
		return this.tenuringInfo;
	}
