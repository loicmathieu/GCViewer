...
public class CreationRateChart extends SimpleChart implements ChangeListener{

	private static final long serialVersionUID = -2938217021057712845L;

	private Ruler metricRuler;
	private CreationRateCharteRenderer creationRateRenderer;
	private int lastViewPortWidth = 0;

	public CreationRateChart() {
		...
		creationRateRenderer = new CreationRateCharteRenderer(this);
		chart.add(creationRateRenderer, gridBagConstraints);
		...
		this.metricRuler = new Ruler(true, 0, 2000, "M");
	...
	public void setModel(GCModel model) {
		...
		this.metricRuler.setMaxUnit(2000);
