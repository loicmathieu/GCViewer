...
public class CumulativeAllocationChart  extends SimpleChart implements ChangeListener{

	private static final long serialVersionUID = -9194349759109785609L;

	private Ruler metricRuler;
	private CumulativeAllocationChartRenderer cumulativeAllocationRenderer;
	private int lastViewPortWidth = 0;

	public CumulativeAllocationChart() {
		...
		cumulativeAllocationRenderer = new CumulativeAllocationChartRenderer(this);
		chart.add(cumulativeAllocationRenderer, gridBagConstraints);
		...
		this.metricRuler = new Ruler(true, 0, getModel().getFreedMemory() / 1024, "M");
	...
	public void setRunningTime(double runningTime) {
		cumulativeAllocationRenderer.invalidate();
	...
	public void setModel(GCModel model) {
		...
		this.metricRuler.setMaxUnit(model.getFreedMemory() / 1024);
